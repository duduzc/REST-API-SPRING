package com.cavalcante.springapi.exceptionhandler;
...
@ControllerAdvice
public class SpringApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String userMessage = messageSource.getMessage("invalid.parameter", null, LocaleContextHolder.getLocale());	
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex,
		...
		String userMessage = messageSource.getMessage("notfound.parameter", null, LocaleContextHolder.getLocale());	
